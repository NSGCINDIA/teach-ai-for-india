-- Teach AI for India — 0065 Ensure school_execution_plans total_budget column & safe RPC review
-- Fixes "column total_budget does not exist" error during Finance Lead budget review.
