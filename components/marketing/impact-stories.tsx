...
const STORIES: StoryCard[] = [
  {
    ...
    body: 'The session had just begun. Thirty students sat quietly, uncertain if they were allowed to touch the tablets. Then a student raised his hand with a grin and asked in Telugu: "Anna, can it make a picture of Allu Arjun?" The volunteer didn\'t say no. In two minutes, the room turned into an active workshop.',
  ...
  },
  {
    ...
    body: 'The 75 minutes were over and materials were packed up, but the students lingered around the desk asking questions about engineering, careers, and coding. One student asked the question that defined our purpose: "Anna, when are you coming again?" That was the exact moment we knew this wasn\'t just a one-off workshop.',
