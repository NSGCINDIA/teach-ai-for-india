  ...
  return (
    <section className="tai-section-lg bg-background">
      <div className="tai-container px-5 md:px-8">
        ...
        <Reveal delay={0.1}>
          <p className="mt-6 text-lg text-foreground">{content.body}</p>
        </Reveal>
        <Reveal delay={0.2}>
          <p className="tai-reading mt-4 text-base text-muted-foreground">
        ...
        <Reveal delay={0.2}>
          <div className="mt-14 border-t border-border pt-10">
            <p className="tai-prose text-sm leading-relaxed text-muted-foreground">{content.ctaNote}</p>
            <Link
              href="/join"
