        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between bg-card/50 dark:bg-card/10 border border-border/80 p-4 rounded-2xl backdrop-blur-sm">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full bg-background dark:bg-card/45 pl-10 pr-4 py-2.5 text-base rounded-xl border border-border/80 outline-none focus:border-brand/40 focus:ring-1 focus:ring-brand/20 transition-all text-foreground"
            />
          </div>
          ...
          <div className="flex items-center gap-3 justify-between sm:justify-start">
            ...
            <select
              ...
              className="bg-background dark:bg-card/45 border border-border/80 rounded-xl px-3.5 py-2.5 text-sm font-semibold text-foreground outline-none focus:border-brand/40 transition-all"
            >
