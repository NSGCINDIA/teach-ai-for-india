...
export const INVITABLE_ROLES: UserRole[] = [
  'mgmt_admin', 'campus_lead', 'outreach_lead', 'exec_lead', 'volunteer_lead', 'volunteer', 'viewer',
  'campus_mgmt_admin', 'finance_lead',
]

/**
 * Roles an applicant may request on public /signup — non-privileged team roles
 * only (an admin still approves). Mirrors the CHECK in 0019/0025. Admin, viewer,
 * school_poc, and the two campus-management/finance roles are invite-only and
 * can never be self-requested.
 */
